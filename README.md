...
|---|---|---|
| Caverns | [`plugins/caverns-delay/`](plugins/caverns-delay/) | Bucket-brigade-style stereo delay |
| Damage | [`plugins/damage-fuzz/`](plugins/damage-fuzz/) | FM-mangled fuzz/distortion |
| Corrosion | [`plugins/corrosion-drive/`](plugins/corrosion-drive/) | Tanh-based distortion/overdrive |
| Flux | [`plugins/flux-phaser/`](plugins/flux-phaser/) | Analog-style phase shifter |
| Alloy | [`plugins/alloy-bass/`](plugins/alloy-bass/) | Stacked analog + FM mono synth |
| Gradient | [`plugins/gradient-pitch/`](plugins/gradient-pitch/) | Pitch-shifting delay |
| Shields | [`plugins/shields-reverb/`](plugins/shields-reverb/) | Diffuse algorithmic reverb with a slow-building swell |
...
Commercially-sold plugins (Inhalt and any future ones built with a collaborator) also live outside
this table entirely, in the private `wj-audio-commercial` repo, which consumes this repo as a
...
[`plugins/common/cmake/FetchJUCE.cmake`](plugins/common/cmake/FetchJUCE.cmake) (currently `9.0.1`). The first
