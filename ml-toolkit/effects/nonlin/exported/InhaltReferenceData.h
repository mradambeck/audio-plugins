...
// AUTO-GENERATED by ml-toolkit/core/export.py (2026-09-19) - do not hand-edit.
...
//
// Provenance:
//   git commit:         2e7f98383af764c647670910ba65d03ffcc0ec6f
...
static constexpr std::array<FittedPoint, 3> high_to_plateau_droop_high_db_per_s_offsetPoints { {
    { -9.0f, -18.944000000000003f },
    { -4.0f, 0.18100000000000094f },
    { 0.0f, 0.0f },
} };
...
static constexpr std::array<FittedPoint, 3> high_to_fall_rate_high_db_per_s_offsetPoints { {
    { -9.0f, 231.88000000000002f },
    { -4.0f, 2.150000000000034f },
    { 0.0f, 0.0f },
} };
...
// time_to_plateau_droop_veryHigh_db_per_s
static constexpr std::array<FittedPoint, 4> time_to_plateau_droop_veryHigh_db_per_sPoints { {
    { 2.2f, 213.698f },
    { 4.8f, 227.317f },
    { 7.0f, 45.447f },
    { 9.8f, 48.94300000000001f },
} };
static_assert(time_to_plateau_droop_veryHigh_db_per_sPoints.front().x <= time_to_plateau_droop_veryHigh_db_per_sPoints.back().x,
    "time_to_plateau_droop_veryHigh_db_per_sPoints must be sorted ascending by x - FittedCurve1D assumes this ordering");

// high_to_plateau_droop_veryHigh_db_per_s_offset
static constexpr std::array<FittedPoint, 3> high_to_plateau_droop_veryHigh_db_per_s_offsetPoints { {
    { -9.0f, -4.491f },
    { -4.0f, -0.2920000000000016f },
    { 0.0f, 0.0f },
} };
static_assert(high_to_plateau_droop_veryHigh_db_per_s_offsetPoints.front().x <= high_to_plateau_droop_veryHigh_db_per_s_offsetPoints.back().x,
    "high_to_plateau_droop_veryHigh_db_per_s_offsetPoints must be sorted ascending by x - FittedCurve1D assumes this ordering");

// time_to_fall_rate_veryHigh_db_per_s
static constexpr std::array<FittedPoint, 6> time_to_fall_rate_veryHigh_db_per_sPoints { {
    { 0.1f, -416.41749999999996f },
    { 0.8f, -87.3375f },
    { 2.2f, -105.31f },
    { 4.8f, -109.68f },
    { 7.0f, -236.429f },
...
static_assert(time_to_fall_rate_veryHigh_db_per_sPoints.front().x <= time_to_fall_rate_veryHigh_db_per_sPoints.back().x,
    "time_to_fall_rate_veryHigh_db_per_sPoints must be sorted ascending by x - FittedCurve1D assumes this ordering");

// high_to_fall_rate_veryHigh_db_per_s_offset
static constexpr std::array<FittedPoint, 3> high_to_fall_rate_veryHigh_db_per_s_offsetPoints { {
    { -9.0f, -7.390000000000015f },
    { -4.0f, 2.530000000000001f },
    { 0.0f, 0.0f },
} };
static_assert(high_to_fall_rate_veryHigh_db_per_s_offsetPoints.front().x <= high_to_fall_rate_veryHigh_db_per_s_offsetPoints.back().x,
    "high_to_fall_rate_veryHigh_db_per_s_offsetPoints must be sorted ascending by x - FittedCurve1D assumes this ordering");
