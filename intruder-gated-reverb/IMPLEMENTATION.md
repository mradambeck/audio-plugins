...
- Using the `juce-hardware-panel-ui` skill, and the `/common/LookAndFeel/MOCKUP+GOUNRD_TRUTH.md`, style the plug-in to look and feel like it belongs within the branding of the other plug-ins hosted in the `audio-plugins` repo.
