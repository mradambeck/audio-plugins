...
# Builds a macOS .pkg installer for Strike.
#
...
#
# Output:
#   installer/output/Strike-AU-Component.pkg          - flat component packages
#   installer/output/Strike-VST3-Component.pkg          (also consumed by the
#   installer/output/Strike-Standalone-Component.pkg    group installer)
#   installer/output/Strike-Installer.pkg              - double-clickable installer
