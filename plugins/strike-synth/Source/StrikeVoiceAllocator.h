...
// StrikeVoice (or any of the four experimental-area classes) - this is pure
...
// plugins/gradient-pitch/GradientDelayBuffer.h for the same pattern applied to a signal-processing class).
//
...
class StrikeVoiceAllocator
{
public:
    StrikeVoiceAllocator() noexcept { reset(); }
