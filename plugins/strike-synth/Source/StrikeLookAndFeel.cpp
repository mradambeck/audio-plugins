...
namespace
{
    ...
    // mockups/strike-mockup.html (see mockups/strike-mockup-reference.png for the reference
    // screenshot) - originally a warm tan/brown (#A57B69) accent, replaced with this green during
    // mockup review.
    const wildjag::HardwarePanelTheme strikeTheme
    {
...
StrikeLookAndFeel::StrikeLookAndFeel() : HardwarePanelLookAndFeel(strikeTheme) {}
