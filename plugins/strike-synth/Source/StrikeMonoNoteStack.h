...
// silently. Framework-free (no JUCE include, just <array>), matching StrikeVoiceAllocator.h's
...
public:
    ...
    // noteOn() no differently than a poly voice does (see StrikeVoice::noteOn()'s own
