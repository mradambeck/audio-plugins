...
class StrikeExcitationTests : public juce::UnitTest
{
public:
    StrikeExcitationTests() : juce::UnitTest("StrikeExcitation", "Strike") {}
    ...
    void runTest() override
    {
        ...
        beginTest("At bowAmount=1 (friction bow), output stays finite and bounded even against an adversarial string signal");
        {
            ...
            // StrikeVoice.h, not this call's own return value). This test isolates the primitive's
        ...
        {
            StrikeExcitation excitationFull;
            StrikeExcitation excitationHalf;
        ...
        {
            StrikeExcitation darkExcitation;
            StrikeExcitation brightExcitation;
            ...
            auto rms = [](StrikeExcitation& excitation)
            {
        ...
        beginTest("Attack is slower as bowAmount approaches 1, for the same note (pluck side unaffected)");
        {
            ...
            // covered separately in StrikeVoiceTests.cpp against the real injection/tanh path).
            auto averageAbs = [](StrikeExcitation& excitation, int numSamples)
            {
                double sum = 0.0;
                for (int i = 0; i < numSamples; ++i)
...
static StrikeExcitationTests strikeExcitationTests;
