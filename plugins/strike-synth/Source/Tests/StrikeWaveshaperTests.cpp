...
class StrikeWaveshaperTests : public juce::UnitTest
{
public:
    StrikeWaveshaperTests() : juce::UnitTest("StrikeWaveFolder", "Strike") {}

    void runTest() override
    {
        beginTest("Zero input always folds to exactly zero, at any amount");
        {
            StrikeWaveFolder folder;
        ...
        beginTest("At amount=0 (minimum drive), a small input passes through nearly unchanged");
        {
            ...
            // amount=0 lives in StrikeStringLineChannel, which never calls process() at all in
...
static StrikeWaveshaperTests strikeWaveshaperTests;

class StrikeBitCrushTests : public juce::UnitTest
{
public:
    StrikeBitCrushTests() : juce::UnitTest("StrikeBitCrush", "Strike") {}
    ...
    void runTest() override
    {
        ...
        beginTest("Output is unconditionally bounded to +-1, regardless of input magnitude or amount");
        {
            // No settling needed (unlike StrikeFuzz/StrikeSaturator's real lowpass filter
...
static StrikeBitCrushTests strikeBitCrushTests;
