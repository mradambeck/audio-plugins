...
# Builds a macOS .pkg installer for Inhalt.
#
...
#
# Output:
#   installer/output/Inhalt-AU-Component.pkg          - flat component packages
#   installer/output/Inhalt-VST3-Component.pkg          (standalone only - deliberately
#   installer/output/Inhalt-Standalone-Component.pkg    NOT registered in the group installer)
#   installer/output/Inhalt-Installer.pkg              - double-clickable installer
