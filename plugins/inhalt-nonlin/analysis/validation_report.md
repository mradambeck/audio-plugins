...
| Fall rate error (dB/s) | -60.303 | -31.385 | -83.438 |
| Plateau droop error (dB/s) | 21.92 | 0.756 | 38.852 |
| Build-up error (ms) | -11.96 | -5.895 | -16.812 |
| Onset NED mean error (0-20ms) | -0.048 | -0.014 | -0.075 |
| Onset NED first-window error | -0.169 | -0.143 | -0.19 |
...
| Log-spectral distance (dB, unsigned) | 2.446 | 2.212 | 2.632 |
| Crest factor error (dB) | -0.331 | -0.796 | 0.041 |
...
| NonLin_4.8s_0H.wav | -13.809 | -9.72 | 0.076 | -4.83 | 2.14 |
| NonLin_7.0s_-7H.wav | 5.238 | -21.91 | 23.486 | -16.712 | 1.73 |
| NonLin_7.0s_0H.wav | -4.921 | -2.47 | -0.045 | -1.927 | 1.66 |
| NonLin_9.8s_-4H.wav | -11.904 | -30.63 | 7.796 | -17.891 | 1.93 |
| NonLin_9.8s_-9H.wav | -12.721 | -22.02 | 12.714 | -16.712 | 1.69 |
| NonLin_9.8s_0H.wav | -0.93 | -9.97 | 1.538 | 0.068 | 1.73 |