...
public:
    ...
    void runTest() override
    {
        ...
        beginTest("Playing one octave up doubles the pitch");
        {
            ...
            ConcreteVoice voice;
            voice.prepare(sampleRate);
            voice.startNote(set, 0, 72, 1.0f, ConcretePitchEngine::Mode::reference, sampleRate, 0, 0.0f, true); // root + 12 semitones
        ...
        beginTest("Playing one octave down halves the pitch");
        {
            ...
            ConcreteVoice voice;
            voice.prepare(sampleRate);
            voice.startNote(set, 0, 48, 1.0f, ConcretePitchEngine::Mode::reference, sampleRate, 0, 0.0f, true); // root - 12 semitones
        ...
        beginTest("A source recorded at a different rate than prepare() still plays at the correct pitch");
        {
            ...
            voice.startNote(set, 0, 60, 1.0f, ConcretePitchEngine::Mode::reference, 48000.0, 0, 0.0f, true);
