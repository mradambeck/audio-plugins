...
# Builds a macOS .pkg installer for Concrete.
#
...
#
# Output:
#   installer/output/Concrete-AU-Component.pkg          - flat component packages
#   installer/output/Concrete-VST3-Component.pkg          (also consumed by the
#   installer/output/Concrete-Standalone-Component.pkg    group installer)
#   installer/output/Concrete-Installer.pkg              - double-clickable installer
#                                                           with welcome/license screens
#
# Usage: installer/build.sh [--component-only]

PLUGIN_NAME="Concrete"
