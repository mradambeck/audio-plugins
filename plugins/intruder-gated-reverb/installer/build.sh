...
# Builds a macOS .pkg installer for Intruder.
#
...
#
# Output:
#   installer/output/Intruder-AU-Component.pkg          - flat component packages
#   installer/output/Intruder-VST3-Component.pkg          (also consumed by the
#   installer/output/Intruder-Standalone-Component.pkg    group installer)
#   installer/output/Intruder-Installer.pkg              - double-clickable installer
#                                                          with welcome/license screens
#
# Usage: installer/build.sh [--component-only]

PLUGIN_NAME="Intruder"
