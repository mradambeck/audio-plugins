...
# Builds a macOS .pkg installer for Aura.
#
...
#
# Output:
#   installer/output/Aura-AU-Component.pkg          - flat component packages
#   installer/output/Aura-VST3-Component.pkg          (also consumed by the
#   installer/output/Aura-Standalone-Component.pkg    group installer)
#   installer/output/Aura-Installer.pkg              - double-clickable installer
