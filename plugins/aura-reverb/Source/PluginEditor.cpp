// Hardware-panel UI, built from the approved mockup (plugins/aura-reverb/mockups/aura-mockup-v1.html,
...
// plugins/caverns-delay/Source/PluginEditor.cpp (the skill's canonical reference) - they don't reference
