...
# Builds a macOS .pkg installer for Damage.
#
...
#
# Output:
#   installer/output/Damage-AU-Component.pkg          - flat component packages
#   installer/output/Damage-VST3-Component.pkg          (also consumed by the
#   installer/output/Damage-Standalone-Component.pkg    group installer)
#   installer/output/Damage-Installer.pkg              - double-clickable installer
#                                                         with welcome/license screens
#
# Usage: installer/build.sh [--component-only]

PLUGIN_NAME="Damage"
PRODUCT_NAME="Damage - Fuzz"
BUNDLE_ID="com.wildjag.damage"
