...
int AlloyAudioProcessor::getNumPrograms() { return 1; }
int AlloyAudioProcessor::getCurrentProgram() { return currentProgramIndex; }
void AlloyAudioProcessor::setCurrentProgram(int) {}
const juce::String AlloyAudioProcessor::getProgramName(int) { return {}; }
