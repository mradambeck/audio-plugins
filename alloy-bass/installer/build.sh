...
# Builds a macOS .pkg installer for Alloy.
#
...
#
# Output:
#   installer/output/Alloy-AU-Component.pkg          - flat component packages
#   installer/output/Alloy-VST3-Component.pkg          (also consumed by the
#   installer/output/Alloy-Standalone-Component.pkg    group installer)
#   installer/output/Alloy-Installer.pkg              - double-clickable installer
...
sign_bundle "$STAGE_DIR/au/${PLUGIN_NAME}.component"
sign_bundle "$STAGE_DIR/vst3/${PLUGIN_NAME}.vst3"
sign_bundle "$STAGE_DIR/standalone/${PLUGIN_NAME}.app"
