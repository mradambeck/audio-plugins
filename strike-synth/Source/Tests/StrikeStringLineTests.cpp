...
// current write position (see StrikeStringLine.h's class comment for why this shape was chosen
...
class StrikeStringLineTests : public juce::UnitTest
{
public:
    StrikeStringLineTests() : juce::UnitTest("StrikeStringLine", "Strike") {}

    void runTest() override
    {
        beginTest("Zero delay returns the most recently written sample, even repeated reads");
        {
            StrikeStringLine<> line;
        ...
        {
            StrikeStringLine<> line; // default Linear interpolation
...
static StrikeStringLineTests strikeStringLineTests;
