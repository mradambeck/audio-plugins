...
# Builds a macOS .pkg installer for Gradient.
#
...
#
# Output:
#   installer/output/Gradient-AU-Component.pkg          - flat component packages
#   installer/output/Gradient-VST3-Component.pkg          (also consumed by the
#   installer/output/Gradient-Standalone-Component.pkg    group installer)
#   installer/output/Gradient-Installer.pkg              - double-clickable installer
