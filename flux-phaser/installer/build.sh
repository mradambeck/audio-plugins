...
# Builds a macOS .pkg installer for Flux.
#
...
#
# Output:
#   installer/output/Flux-AU-Component.pkg          - flat component packages
#   installer/output/Flux-VST3-Component.pkg          (also consumed by the
#   installer/output/Flux-Standalone-Component.pkg    group installer)
#   installer/output/Flux-Installer.pkg              - double-clickable installer
