...
class KarplunkRingModulatorTests : public juce::UnitTest
{
public:
    KarplunkRingModulatorTests() : juce::UnitTest("KarplunkRingModulator", "Karplunk") {}
...
static KarplunkRingModulatorTests karplunkRingModulatorTests;
