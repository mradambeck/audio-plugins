...
class KarplunkVoiceAllocatorTests : public juce::UnitTest
{
public:
    KarplunkVoiceAllocatorTests() : juce::UnitTest("KarplunkVoiceAllocator", "Karplunk") {}

    void runTest() override
    {
        beginTest("Allocates free (inactive) voices in order before stealing anything");
        {
            KarplunkVoiceAllocator<4> allocator;
        ...
        {
            KarplunkVoiceAllocator<3> allocator;
        ...
        {
            KarplunkVoiceAllocator<2> allocator;
...
static KarplunkVoiceAllocatorTests karplunkVoiceAllocatorTests;
