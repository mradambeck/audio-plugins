    ...
    const std::vector<FactoryPreset>& getFactoryPresets()
    {
        static const std::vector<FactoryPreset> presets = {
            { "Shine", {
                ...
                { CavernsAudioProcessor::leftSubdivisionParamID, (float) defaultSubdivisionIndex },
                { CavernsAudioProcessor::rightSubdivisionParamID, (float) defaultSubdivisionIndex },
                { CavernsAudioProcessor::leftTimeParamID, 350.0f },
                { CavernsAudioProcessor::rightTimeParamID, 337.6f },
                { CavernsAudioProcessor::feedbackParamID, 24.5f },
                { CavernsAudioProcessor::dryParamID, 100.0f },
                { CavernsAudioProcessor::wetParamID, 86.3f },
                { CavernsAudioProcessor::lowCutParamID, 280.0f },
                { CavernsAudioProcessor::highCutParamID, 6340.0f },
                { CavernsAudioProcessor::modSpeedParamID, 5.86f },
                { CavernsAudioProcessor::modDepthParamID, 2.38f },
                { CavernsAudioProcessor::degradeParamID, 22.3f },
            } },
        };
